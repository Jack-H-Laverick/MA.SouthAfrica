...
Seas Around Us data were compared to available visualisations and data on species catch from the 2023 Status of Marine Living Resources report from the South Africa Department of Forestry, Fisheries and the Environment [@dffe23]. Seas Around Us data were found to generally represent these catch data closely where available. However, it is acknowledged that Seas Around Us data likely diverges from official data to a greater degree for the species/sectors that are not included in the 2023 report. Seas Around Us include qualitative uncertainty scores for each catch data entry. The scores present in the Seas Around Us data used include NA (unknown/unassessed uncertainty), 1 (+/- 50%, low agreement and low evidence) and 2 (+/- 30%, high agreement and limited evidence, or medium agreement and medium evidence, or low agreement and robust evidence). Most data for this region have a score of 1, with little variation during the 2010-2019 period. It is noted that catch reconstruction for the South Africa region was developed for the 1950-2010 period, and then was subsequently updated for years post-2010 [@baust20].
