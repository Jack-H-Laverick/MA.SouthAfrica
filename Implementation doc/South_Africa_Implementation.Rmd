...
There are an estimated 14 migratory species in the migratory fish guild for the domain, with Yellowfin Tuna remaining in the domain region year-round (pers comms Shannon and Ortega-Cisneros (2025).), therefore we estimate the proportion of migratory fish domain-biomass that remains in the domain year round as 1/14. In addition Tunas and Swordfish have a general domain presence from November to March, thus we parameterise the Immigration of these species as starting in November (300 days since Jan 1), spanning for one month (330 days since Jan 1) and the emmigration of these species from the domain as starting in March (60 days since Jan 1), spanning for one month (90 days since Jan 1).
We take the total ocean biomass of migratory fish to be equal to the value from the closest existing implementation (Saint Helena Island), with 5,214,177 tonnes wet weight. To estimate the proportion of this ocean biomass entering the model domain each year, we use the biomass estimate for Tuna and Swordfish from Shannon et al. (2020) as a proxy for migratory fish guild biomass in the domain.
...
These data are derived from an Ecopath with Ecosim model of the Southern Benguela region.
