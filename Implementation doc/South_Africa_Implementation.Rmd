...
Species in Seas Around Us data that were previously not accounted for in StrathE2E guilds were allocated to guilds based on diet composition and movement information from FishBase. Snoek (*Thyrsites atun*), previously allocated to demersal fish in StrathE2E, was allocated to Migratory fish due to it's migratory nature in the model domain and to align with the species classification in EwE application from [-@shannon20]. Yellowtail Kingfish (*Seriola lalandi*), previously allocated to planktivorous fish, was allocated to Demersal fish due to it's predatory ecology and classification in EwE from [-@shannon20].
