...
write.csv(target_data, glue("./StrathE2E/Models/{implementation}/2010-2019/Param/annual_observed_{toupper(implementation)}_{start_year}-{end_year}.csv"), row.names = FALSE)
