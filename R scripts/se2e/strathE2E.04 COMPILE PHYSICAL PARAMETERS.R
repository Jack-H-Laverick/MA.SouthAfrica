...
Physical_parameters <- read.csv("./StrathE2E/South_Africa/2010-2019/Param/physical_parameters_CELTIC_SEA.csv") # Read in example Physical drivers
...
write.csv(Physical_parameters,
          file = "./StrathE2E/South_Africa/2010-2019/Param/physical_parameters_SOUTH_AFRICA.csv", 
          row.names = F)
