...
file.copy(
    from = "./Objects/fishing_activity{toupper{implementation}}_{start_year}-{end_year}.csv",
...
file.copy(
    from = "./Objects/fishing_distribution{toupper{implementation}}_{start_year}-{end_year}.csv",
    to = "./StrathE2E/Models/{implementation}/2010-2019/Param/",
    overwrite = TRUE
)
...
# Copy fishing power
file.copy(
    from = glue("./Objects/fishing_power{toupper{implementation}}_{start_year}-{end_year}.csv"),
    to = "./StrathE2E/Models/{implementation}/2010-2019/Param/",
    overwrite = TRUE
)
...
file.copy(
    from = glue("./Objects/fishing_discards{toupper{implementation}}_{start_year}-{end_year}.csv"),
    to = "./StrathE2E/Models/{implementation}/2010-2019/Param/",
    overwrite = TRUE
)
...
file.copy(
    from = glue("./Objects/fishing_processing{toupper{implementation}}_{start_year}-{end_year}.csv"),
    to = "./StrathE2E/Models/{implementation}/2010-2019/Param/",
    overwrite = TRUE
)
...
file.copy(
    ...
    to = glue("./StrathE2E/Models/{implementation}/2010-2019/Param/fishing_fleet{toupper{implementation}}_{start_year}-{end_year}.csv"),
    overwrite = TRUE
)
...
write.csv(fishing_gear_multiplier, glue("./StrathE2E/Models/{implementation}/2010-2019/Param/fishing_gear_multiplier{toupper{implementation}}_{start_year}-{end_year}.csv"), row.names = FALSE)
