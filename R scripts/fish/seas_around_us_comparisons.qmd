...
![](/seas_around_us_comparisons_files/figure-html/agulhas_sole_stock_status_2023.png)
...
![](/seas_around_us_comparisons_files/figure-html/cape_hakes_stock_status_2023.png)
...
![](/seas_around_us_comparisons_files/figure-html/cape_horse_mackerel_stock_status_2023.png)
...
![](/seas_around_us_comparisons_files/figure-html/monkfish_stock_status_2023.png)
...
![](/seas_around_us_comparisons_files/figure-html/small_pelagic_fish_stock_status_2023.png)
...
![](/seas_around_us_comparisons_files/figure-html/squids_stock_status_2023.png)
...
![](/seas_around_us_comparisons_files/figure-html/soupfin_and_smoothhound_stock_status_2023.png)
...
## Looking at the distribution of landings across gear types in Seas-Around-Us data
...
To compare landings more closely with chosen gear types (above) they have been collated to approximate these gear types. (Note that a pelagic and a demersal longline class are separate in our proposed gear types, but SAU data only has 'longline'. And there is no squid jig gear type in SAU data so this label has been given to 'small scale lines' as this is the gear type catching *Loligo* squid in SAU data.):
...
**Findings**: Overall purse seine gear type dominates distribution of catch (tonnes). Purse seine catch is mainly made up of planktivorous species (see [Sardine, Anchovy and Herring](## Small pelagic fish (sardine, anchovy and herring))). The proportion of catch from the trawl gear classes increases from 1980s. `Other gears` which includes miscellaneous gear types such as small scale pots, subsistence and artisinal fishing occupies an increasing proportion from 1990s onwards, as does the `small scale lines / squid jig` gear type. `nets (including small scale nets)`, `linefishery` and `longline` gear types have very low proportions of overall catch.
...
Distribution of purse-seine gear type landings
