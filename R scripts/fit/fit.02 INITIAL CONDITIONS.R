...
model <- e2e_read(implementation, str_glue("2010-2019-{Force}-{S}"), models.path = "StrathE2E/", results.path = "StrathE2E/Results/",
                  model.ident = stringr::str_glue("2010-2019-{Force}-{S}"))
...
file.rename(stringr::str_glue("./StrathE2E/{implementation}/2010-2019-{Force}-{S}/Param/initial_values-2010-2019-{Force}-{S}.csv"),
